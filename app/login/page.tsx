            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {mode !== 'forgot-password' && (
                <div>
                  ...
                  <input id="login-password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" required className="input-dark" autoComplete={mode === 'signup' ? 'new-password' : 'current-password'} />
